...
from mole3.stat_corr import rb_contemporary_wall_uvalue_by_building_age_lookup
from mole3.stat_corr import nrb_contemporary_wall_uvalue_by_building_age_lookup
...
extension = OeQExtension(
    ...
    active=True,
    show_results=['WL_UEH'],
    description="Calculate the EnEV Heritage U-Value of the Building's walls",
