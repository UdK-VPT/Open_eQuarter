...
from mole3.stat_corr import rb_present_base_uvalue_AVG_by_building_age_lookup, nrb_present_base_uvalue_by_building_age_lookup, rb_contemporary_base_uvalue_by_building_age_lookup, nrb_contemporary_base_uvalue_by_building_age_lookup
...
extension = OeQExtension(
    ...
    active=True,
    show_results=['BS_UPH'],
    description="Calculate the present heritage U-Value of the Building's baseplate",
