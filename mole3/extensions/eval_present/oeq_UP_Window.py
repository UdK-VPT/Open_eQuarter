...
from mole3.stat_corr import rb_present_window_uvalue_AVG_by_building_age_lookup, nrb_present_window_uvalue_by_building_age_lookup
...
extension = OeQExtension(
    ...
    active=True,
    show_results=['WN_UP'],
    description="Calculate the present U-Value of the Building's windoes",
