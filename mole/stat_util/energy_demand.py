...
#def dummy(x):
  ...
  #base_uvalue_pres=stat_corr.present_base_uvalue_AVG_by_building_age_lookup(year_of_construction)
  ...
  wall_uvalue_pres=present_wall_uvalue_AVG_by_building_age_lookup(year_of_construction)
  ...
  window_uvalue_pres=present_window_uvalue_AVG_by_building_age_lookup(year_of_construction)
  window_loss_pres=window_area*window_uvalue_pres*accumulated_heating_hours/1000
  
  roof_area=floor_area
  roof_uvalue_pres=stat_corr.present_roof_uvalue_AVG_by_building_age_lookup(year_of_construction)
  ...
  return {"WDT_AVG":building_width,
              "LEN_AVG":building_length,
