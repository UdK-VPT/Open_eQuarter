...
# Form implementation generated from reading ui file '/Users/wk/Tresors/VPT/Open eQuarter/Development/oeq_git/mole3/view/ui_project_settings_form.ui'
#
...
"    color: rgb(0,0,0);\n"
"}"))
        self.verticalLayout = QtWidgets.QVBoxLayout(project_settings_form)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.form = QtWidgets.QFrame(project_settings_form)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.project_name_label)
        self.project_name = QtWidgets.QLineEdit(self.form)
        ...
        self.description_label = QtWidgets.QLabel(self.form)
        ...
        self.description = QtWidgets.QPlainTextEdit(self.form)
        ...
        self.city_label = QtWidgets.QLabel(self.form)
        self.city_label.setObjectName(_fromUtf8("city_label"))
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.city_label)
        self.location_city_layout = QtWidgets.QHBoxLayout()
        ...
        self.lookup_by_address = QtWidgets.QPushButton(self.form)
        ...
        self.formLayout.setLayout(4, QtWidgets.QFormLayout.FieldRole, self.location_city_layout)
        self.zip_label = QtWidgets.QLabel(self.form)
        self.zip_label.setObjectName(_fromUtf8("zip_label"))
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.zip_label)
        self.location_postal_layout = QtWidgets.QHBoxLayout()
        ...
        self.formLayout.setLayout(6, QtWidgets.QFormLayout.FieldRole, self.location_postal_layout)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.formLayout.setItem(7, QtWidgets.QFormLayout.FieldRole, spacerItem1)
        self.longitude_label = QtWidgets.QLabel(self.form)
        self.longitude_label.setObjectName(_fromUtf8("longitude_label"))
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.longitude_label)
        self.location_lon_layout = QtWidgets.QHBoxLayout()
        self.location_lon_layout.setObjectName(_fromUtf8("location_lon_layout"))
        self.location_lon = QtWidgets.QLineEdit(self.form)
        ...
        self.lookup_by_coords = QtWidgets.QPushButton(self.form)
        ...
        self.formLayout.setLayout(8, QtWidgets.QFormLayout.FieldRole, self.location_lon_layout)
        self.lattitude_label = QtWidgets.QLabel(self.form)
        self.lattitude_label.setObjectName(_fromUtf8("lattitude_label"))
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.lattitude_label)
        self.location_lat = QtWidgets.QLineEdit(self.form)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.location_lat)
        self.crs_label = QtWidgets.QLabel(self.form)
        self.crs_label.setObjectName(_fromUtf8("crs_label"))
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.crs_label)
        self.location_crs = QtWidgets.QLineEdit(self.form)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.location_crs)
        spacerItem2 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.formLayout.setItem(11, QtWidgets.QFormLayout.FieldRole, spacerItem2)
        self.heating_degree_days_label = QtWidgets.QLabel(self.form)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.LabelRole, self.heating_degree_days_label)
        self.heating_degree_days = QtWidgets.QLineEdit(self.form)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.heating_degree_days)
        self.average_build_year_label = QtWidgets.QLabel(self.form)
        self.average_build_year_label.setObjectName(_fromUtf8("average_build_year_label"))
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.LabelRole, self.average_build_year_label)
        self.average_build_year = QtWidgets.QLineEdit(self.form)
        ...
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.FieldRole, self.average_build_year)
        self.population_density_label = QtWidgets.QLabel(self.form)
        self.population_density_label.setObjectName(_fromUtf8("population_density_label"))
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.LabelRole, self.population_density_label)
        self.population_density = QtWidgets.QLineEdit(self.form)
        ...
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.FieldRole, self.population_density)
        spacerItem3 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.formLayout.setItem(15, QtWidgets.QFormLayout.LabelRole, spacerItem3)
        self.street_label = QtWidgets.QLabel(self.form)
        self.street_label.setObjectName(_fromUtf8("street_label"))
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.street_label)
        self.location_street_layout = QtWidgets.QHBoxLayout()
        self.location_street_layout.setObjectName(_fromUtf8("location_street_layout"))
        self.location_street = QtWidgets.QLineEdit(self.form)
        ...
        self.formLayout.setLayout(5, QtWidgets.QFormLayout.FieldRole, self.location_street_layout)
        self.country_label = QtWidgets.QLabel(self.form)
        self.country_label.setObjectName(_fromUtf8("country_label"))
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.country_label)
        self.location_country_layout = QtWidgets.QHBoxLayout()
        self.location_country_layout.setObjectName(_fromUtf8("location_country_layout"))
        self.location_country = QtWidgets.QLineEdit(self.form)
        ...
        self.formLayout.setLayout(3, QtWidgets.QFormLayout.FieldRole, self.location_country_layout)
        self.gridLayout.addLayout(self.formLayout, 0, 0, 1, 1)
        self.verticalLayout.addWidget(self.form)
        self.retranslateUi(project_settings_form)
        self.buttonBox.accepted.connect(project_settings_form.accept)
        self.buttonBox.rejected.connect(project_settings_form.reject)
        self.location_postal.editingFinished.connect(self.lookup_by_address.click)
