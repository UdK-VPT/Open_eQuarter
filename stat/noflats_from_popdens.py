# OeQ autogenerated correlation for 'Number of flats depending on th population density'

import math
import numpy as np
def noflats_from_popdens(xin,mode='distribution',weights=None):
    if weights is None:
        weights=np.repeat(1,5)
    ...
    return(BLD_NOFLAT_1/l_sum * weights[0] + BLD_NOFLAT_2/l_sum * weights[1] + BLD_NOFLAT_3TO6/l_sum * weights[2] + BLD_NOFLAT_7TO12/l_sum * weights[3] + BLD_NOFLAT_MTH13/l_sum * weights[4] )

print  noflats_from_popdens(500)
