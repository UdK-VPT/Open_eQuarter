...
from mole3.stat_corr import rb_contemporary_roof_uvalue_by_building_age_lookup
from mole3.stat_corr import nrb_contemporary_roof_uvalue_by_building_age_lookup
...
extension = OeQExtension(
    ...
    active=True,
    show_results=['RF_UEH'],
    description="Calculate the EnEV Heritage U-Value of the Building's roof",
