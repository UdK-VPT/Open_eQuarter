...
def evaluate_building(population_density, 
  ...
  owner_keys=list(bld_owners_rate.keys())
  ...
  owner_keys=list(flt_owners_rate.keys())
  ...
  heating_keys=list(bld_heating_rate.keys())
  ...
  heating_keys=list(flt_heating_rate.keys())
