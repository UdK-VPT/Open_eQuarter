# OeQ autogenerated correlation function: Owner Distribution in Correlation to the population density

owner_distribution_by_population_density_correlation<-function(...){
# OeQ autogenerated correlation for 'Buildings with housing owned by assiciations'
BLD_OWNER_ASSOC = correlation(
    Const = 0.0312402617762994,
    a = 0.0118744160583816,
    b = -0.00729746079841895,
    c = 0.00173208156048849,
    d = -9.5352686670591e-05,
    mode="log")
