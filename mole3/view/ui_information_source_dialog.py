...
# Form implementation generated from reading ui file '/Users/wk/Tresors/VPT/Open eQuarter/Development/oeq_git/mole3/view/ui_information_source_dialog.ui'
#
...
class Ui_InformationSource_dialog(object):
    def setupUi(self, InformationSource_dialog):
        ...
        self.verticalLayout = QtWidgets.QVBoxLayout(InformationSource_dialog)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.gridWidget = QtWidgets.QWidget(InformationSource_dialog)
...
"}"))
        ...
        self.open_csv_btn = QtWidgets.QPushButton(self.gridWidget)
        ...
        self.open_shapefile_btn = QtWidgets.QPushButton(self.gridWidget)
        ...
        self.gtiff = QtWidgets.QLineEdit(self.gridWidget)
        self.gtiff.setObjectName(_fromUtf8("gtiff"))
        self.grid.addWidget(self.gtiff, 10, 2, 1, 1)
        self.blind3 = QtWidgets.QPushButton(self.gridWidget)
        ...
        self.dxf = QtWidgets.QLineEdit(self.gridWidget)
        ...
        self.blind4 = QtWidgets.QPushButton(self.gridWidget)
        ...
        self.layer_name = QtWidgets.QLineEdit(self.gridWidget)
        ...
        self.blind2 = QtWidgets.QPushButton(self.gridWidget)
        ...
        self.open_dxf_btn = QtWidgets.QPushButton(self.gridWidget)
        ...
        self.wms = QtWidgets.QLineEdit(self.gridWidget)
        self.wms.setObjectName(_fromUtf8("wms"))
        self.grid.addWidget(self.wms, 9, 2, 1, 1)
        self.blind1 = QtWidgets.QPushButton(self.gridWidget)
        ...
        self.extension_dropdown = QtWidgets.QComboBox(self.gridWidget)
        ...
        self.wfs = QtWidgets.QLineEdit(self.gridWidget)
        ...
        self.shp = QtWidgets.QLineEdit(self.gridWidget)
        self.shp.setObjectName(_fromUtf8("shp"))
        self.grid.addWidget(self.shp, 12, 2, 1, 1)
        self.open_geotiff_btn = QtWidgets.QPushButton(self.gridWidget)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(InformationSource_dialog)
        ...
        self.buttonBox.accepted.connect(InformationSource_dialog.accept)
        self.buttonBox.rejected.connect(InformationSource_dialog.reject)

        #QtCore.QObject.connect(self.buttonBox, QtCore.pyqtSignal(_fromUtf8("accepted()")), InformationSource_dialog.accept)
        #QtCore.QObject.connect(self.buttonBox, QtCore.pyqtSignal(_fromUtf8("rejected()")), InformationSource_dialog.reject)
