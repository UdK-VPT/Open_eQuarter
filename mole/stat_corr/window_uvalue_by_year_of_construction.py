# OeQ autogenerated correlation for 'Typical Window U-Value in correlation to year of construction'

import math
import numpy as np
def window_uvalue_by_year_of_construction(xin,mode='distribution'):
