...
# Form implementation generated from reading ui file '/Users/wk/Tresors/VPT/Open eQuarter/Development/oeq_git/mole3/view/ui_main_process_dock.ui'
#
...
""))
        ...
        self.menu_bar = QtWidgets.QWidget(self.dockWidgetContents)
        ...
        self.settings_dropdown_btn = QtWidgets.QToolButton(self.menu_bar)
        ...
        self.settings_dropdown_btn.setPopupMode(QtWidgets.QToolButton.InstantPopup)
        ...
        self.tools_dropdown_btn = QtWidgets.QToolButton(self.menu_bar)
        icon1 = QtGui.QIcon()
        ...
        self.tools_dropdown_btn.setPopupMode(QtWidgets.QToolButton.InstantPopup)
        ...
        self.active_page_dropdown = QtWidgets.QComboBox(self.dockWidgetContents)
        ...
        self.process_page = QtWidgets.QStackedWidget(self.dockWidgetContents)
        ...
        self.process_page.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.process_page.setFrameShadow(QtWidgets.QFrame.Plain)
        ...
        self.oeq_requirements = QtWidgets.QWidget()
        ...
        self.Requirements = QtWidgets.QVBoxLayout(self.oeq_requirements)
        ...
        self.oeq_project_basics = QtWidgets.QWidget()
        ...
        self.Project = QtWidgets.QVBoxLayout(self.oeq_project_basics)
        ...
        self.oeq_informationsources = QtWidgets.QWidget()
        self.oeq_informationsources.setObjectName(_fromUtf8("oeq_informationsources"))
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.oeq_informationsources)
        ...
        self.oeq_building_evaluation = QtWidgets.QWidget()
        ...
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.oeq_building_evaluation)
        ...
        self.automode = QtWidgets.QCheckBox(self.dockWidgetContents)
        ...
        self.process_button_next = QtWidgets.QPushButton(self.dockWidgetContents)
        ...
        self.active_page_dropdown.currentIndexChanged.connect(self.process_page.setCurrentIndex)
        self.automode.clicked.connect(self.run_button.setEnabled)
