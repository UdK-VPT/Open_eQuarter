...
setConstructorS3("OeQ_Model", function(name="",verb_prn="",verb_scr="",...){ # Constructor for a single regression model 1
  ...
  this <- extend(Object(), "OeQ_Model",         # model name
                 ...
                 .rangewidth=0,
                 .validity=0,
                 .verb_prn=expression(verb_prn),         # verbose formula (expression)
                 .verb_scr=verb_scr)                   # verbose formula (string)
  this;
})
...
#get prediction of the best fit as vector or data.frame
setMethodS3("verb_prn", "OeQ_Regr", function(this,...){return(this[[this$.bestfit]]$.verb_prn)})

#get prediction of the best fit as vector or data.frame
setMethodS3("verb_scr", "OeQ_Regr", function(this,...){return(this[[this$.bestfit]]$.verb_scr)})
...
setMethodS3("init", "OeQ_Regr", function(this,limit=NULL,plt_title="",...){
  ...
  this$.spline$.verb_prn="Natural Spline"       
  this$.spline$.verb_scr="Natural Spline"                  
  ...
  this$.splinelog$.verb_prn="Natural Spline (Log)" 
  this$.splinelog$.verb_scr="Natural Spline (Log)"
  ...
  this$.smoothspline$.verb_prn="Smooth Spline"   
  this$.smoothspline$.verb_scr="Smooth Spline" 
  ...
  this$.smoothsplinelog$.verb_prn="Smooth Spline (Log)"             
  this$.smoothsplinelog$.verb_scr="Smooth Spline (Log)"      
  ...
  this$.lm1$.name=".lm1"
  this$.lm1$.verb_prn=expression(paste("y = Const ",+ ax + bx^2 + cx^3))        
  this$.lm1$.verb_scr="f ( x ) = Const + ax + bx^2 + cx^3"      
 ...
 # y=l.y_comp
  ...
  this$.lm1log$.verb_prn=expression(paste("y = Const + a",tilde(x)," + b ",tilde(x)^2," + c",tilde(x)^3," ; ",tilde(x)," = ln(x) "))        
  this$.lm1log$.verb_scr="y = Const + ax + bx^2 + cx^3 (x<-log(x))"      
...
# this$.lm1log$.model<-lm(y ~ poly(log(x),3,raw=TRUE))
 ...
 # if((this$.lm1log$.sqderiv < this[[this$.bestfit]]$.sqderiv)&&(this$.lm1log$.validity >= this[[this$.bestfit]]$.validity))  { 
  ...
  this$.lm2$.name=".lm2"
  this$.lm2$.verb_prn=expression(paste("y = Const ",+ ax + bx^2 + cx^3 + dx^4))        
  this$.lm2$.verb_scr="f ( x ) = Const + ax + bx^2 + cx^3 + dx^4"      
 ...
 this$.lm2$.sqderiv=sum((l.y_comp-l.prediction)^2)                     
  ...
  this$.lm2log$.verb_prn=expression(paste("y = Const + a",tilde(x)," + b ",tilde(x)^2," + c",tilde(x)^3," + d",tilde(x)^4," ; ",tilde(x)," = ln(x) "))        
  this$.lm2log$.verb_scr="f ( x ) = Const + ax + bx^2 + cx^3  + dx^4 (Log)"      
...
this$.lm2log$.sqderiv=sum((l.y_comp-l.prediction)^2)                     
  ...
  this$.lm1_splined$.verb_prn=expression(paste("y = Const ",+ ax + bx^2 + cx^3))        
  this$.lm1_splined$.verb_scr="f ( x ) = Const + ax + bx^2 + cx^3"      
 ...
 this$.lm1_splined$.sqderiv=sum((l.y_comp-l.prediction)^2)                     
  ...
  this$.lm1log_splined$.verb_prn=expression(paste("y = Const + a",tilde(x)," + b ",tilde(x)^2," + c",tilde(x)^3," ; ",tilde(x)," = ln(x) "))        
  this$.lm1log_splined$.verb_scr="f ( x ) = Const + ax + bx^2 + cx^3 (Log)"      
 ...
 this$.lm1log_splined$.sqderiv=sum((l.y_comp-l.prediction)^2)                     
  ...
  this$.lm2_splined$.verb_prn=expression(paste("y = Const ",+ ax + bx^2 + cx^3 + dx^4))        
  this$.lm2_splined$.verb_scr="f ( x ) = Const + ax + bx^2 + cx^3 + dx^4"      
 ...
 this$.lm2_splined$.sqderiv=sum((l.y_comp-l.prediction)^2)                     
  ...
  this$.lm2log_splined$.verb_prn=expression(paste("y = Const + a",tilde(x)," + b ",tilde(x)^2," + c",tilde(x)^3," + d",tilde(x)^4," ; ",tilde(x)," = ln(x) "))        
  this$.lm2log_splined$.verb_scr="f ( x ) = Const + ax + bx^2 + cx^3  + dx^4 (Log)"      
 ...
 #Validity of the regression is done by a range check: 
  ...
  this$.lm1_logsplined$.verb_prn=expression(paste("y = Const ",+ ax + bx^2 + cx^3))        
  this$.lm1_logsplined$.verb_scr="f ( x ) = Const + ax + bx^2 + cx^3"      
 ...
 this$.lm1_logsplined$.sqderiv=sum((l.y_comp-l.prediction)^2)                     
  ...
  this$.lm1log_logsplined$.verb_prn=expression(paste("y = Const + a",tilde(x)," + b ",tilde(x)^2," + c",tilde(x)^3," ; ",tilde(x)," = ln(x) "))        
  this$.lm1log_logsplined$.verb_scr="f ( x ) = Const + ax + bx^2 + cx^3 (Log)"      
 ...
 this$.lm1log_logsplined$.sqderiv=sum((l.y_comp-l.prediction)^2)                     
  ...
  this$.lm2_logsplined$.verb_prn=expression(paste("y = Const ",+ ax + bx^2 + cx^3 + dx^4))        
  this$.lm2_logsplined$.verb_scr="f ( x ) = Const + ax + bx^2 + cx^3 + dx^4"      
 ...
 this$.lm2_logsplined$.sqderiv=sum((l.y_comp-l.prediction)^2)      
  ...
  this$.lm2log_logsplined$.verb_prn=expression(paste("f ( ",tilde(x)," ) = Const + a",tilde(x)," + b ",tilde(x)^2," + c",tilde(x)^3," + d",tilde(x)^4," ; ",tilde(x)," = ln(x) "))        
  this$.lm2log_logsplined$.verb_scr="f ( x ) = Const + ax + bx^2 + cx^3  + dx^4 (Log)"      
