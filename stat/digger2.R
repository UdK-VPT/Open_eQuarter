...
# generate generate_correlation_code_snippet_in_R snippet for this model
setMethodS3("generate_correlation_code_snippet_in_R", "OeQ_Model", function(this,par_name,description=NULL,...){
  ...
  l.code=paste("# OeQ autogenerated correlation for '",description,"'\n",
               par_name," = correlation(",paste(l.coeffnames,"=",this$.model$coefficients,collapse=","),",mode=\"",this$.mode,"\")\n",sep="")
...
setMethodS3("generate_correlation_function_in_R", "OeQ_Inv", function(this,fun_name,description,filename=NULL,weights=NULL,...){
  ...
  for (i in this$.regressions) {
    l.code=paste(l.code, "x=xin\n\n",sep="")
    l.code=paste(l.code, i$generate_bestfit_correlation_code_snippet_in_R(),sep="") 
