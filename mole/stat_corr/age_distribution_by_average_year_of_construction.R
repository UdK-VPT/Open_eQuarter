# OeQ autogenerated correlation function: Buildings built in correlation to year of construction
age_distribution_by_average_year_of_construction<-function(xin,mode='distribution',weights=NULL,...){
x=xin
...
return(BLD_AGE1_BEFORE1919/l.sum * 1 + BLD_AGE1_1919TO1949/l.sum * 1 + BLD_AGE1_1950TO1959/l.sum * 1 + BLD_AGE1_1960TO1969/l.sum * 1 + BLD_AGE1_1970TO1979/l.sum * 1 + BLD_AGE1_1980TO1989/l.sum * 1 + BLD_AGE1_1990TO1999/l.sum * 1 + BLD_AGE1_2000TO2005/l.sum * 1 + BLD_AGE1_AFTER2006/l.sum * 1 )
}
