...
from mole3.stat_corr import nrb_contemporary_base_uvalue_by_building_age_lookup
...
extension = OeQExtension(
    ...
    active=True,
    show_results=['BS_UEH'],
    description="Calculate the EnEV Heritage U-Value of the Building's baseplate",
